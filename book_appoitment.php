...
try {
    ...
    $stmt = $pdo->prepare("
        ...
        (sender_id, sender_type, receiver_id, receiver_type, subject, message_body, message_type, related_flat, related_request) 
        VALUES (:sender_id, 'customer', 
                (SELECT owner_id FROM flats WHERE ref_number = :flat_id), 'owner',
    ...
    header("Location: appointment_request.php?flat_id=" . $flatId);
    exit;
}
